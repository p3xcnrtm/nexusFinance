        ...
        <div className="glass-panel rounded-2xl p-8 md:p-16 overflow-hidden relative">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center relative z-10">
            <div className="order-2 md:order-1">
              ...
              <div className="mt-8">
                 <a href="mailto:Flynnthomas907@my.com" className="text-nexus-gold hover:underline flex items-center gap-2">
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:Flynnthomas907@my.com" className="text-blue-300 hover:text-nexus-gold transition-colors">Flynnthomas907@my.com</a>
                </div>
              </div>
              ...
              <div className="p-6 bg-nexus-gold/10 border border-nexus-gold/20 rounded-lg mt-8">
                ...
                <a href="mailto:Flynnthomas907@my.com?subject=Schedule%20a%20Strategy%20Call" className="w-full py-3 bg-nexus-gold text-nexus-dark font-bold rounded-sm hover:bg-white transition-colors block text-center">
                  Schedule Now
                </a>
              </div>
            </div>
            ...
            <form className="space-y-4" onSubmit={async (e) => {
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input type="text" name="firstName" required className="w-full bg-nexus-dark border border-white/10 rounded-sm p-3 text-white focus:border-nexus-gold outline-none transition-colors" />
                </div>
                <div>
                  <label className="block text-xs uppercase tracking-wider text-slate-500 mb-2">Last Name</label>
                  <input type="text" name="lastName" required className="w-full bg-nexus-dark border border-white/10 rounded-sm p-3 text-white focus:border-nexus-gold outline-none transition-colors" />
                </div>
              </div>
              <div>
                <label className="block text-xs uppercase tracking-wider text-slate-500 mb-2">Email Address</label>
                <input type="email" name="email" required className="w-full bg-nexus-dark border border-white/10 rounded-sm p-3 text-white focus:border-nexus-gold outline-none transition-colors" />
              </div>
              <div>
                <label className="block text-xs uppercase tracking-wider text-slate-500 mb-2">Investment Interest</label>
                <select name="interest" required className="w-full bg-nexus-dark border border-white/10 rounded-sm p-3 text-white focus:border-nexus-gold outline-none transition-colors">
                  <option value="Crypto Portfolio Management">Crypto Portfolio Management</option>
                  <option value="Fiat Asset Strategies">Fiat Asset Strategies</option>
                  <option value="Wealth Structuring">Wealth Structuring</option>
                  <option value="Other">Other</option>
                </select>
              </div>
              <div>
                <label className="block text-xs uppercase tracking-wider text-slate-500 mb-2">Message</label>
                <textarea name="message" required rows={4} className="w-full bg-nexus-dark border border-white/10 rounded-sm p-3 text-white focus:border-nexus-gold outline-none transition-colors"></textarea>
              </div>
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-blue-300">
              <li><Link to="/privacy-policy" className="hover:text-nexus-gold transition-colors">Privacy Policy</Link></li>
              <li><Link to="/terms-of-service" className="hover:text-nexus-gold transition-colors">Terms of Service</Link></li>
              <li><Link to="/risk-disclosure" className="hover:text-nexus-gold transition-colors">Risk Disclosure</Link></li>
              <li><Link to="/cookie-policy" className="hover:text-nexus-gold transition-colors">Cookie Policy</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <form className="flex" onSubmit={async (e) => {
              ...
              <input type="email" name="email" required placeholder="Email Address" className="bg-white/5 border border-white/10 px-4 py-2 rounded-l-sm text-sm text-white outline-none focus:border-nexus-gold w-full" />
              <button type="submit" className="bg-nexus-gold text-nexus-dark px-4 py-2 rounded-r-sm font-bold hover:bg-white transition-colors">
