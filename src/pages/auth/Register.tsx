    ...
    <div className="min-h-screen bg-nexus-dark flex items-center justify-center p-6 relative overflow-hidden">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold text-white mb-2">Create Investor Account</h2>
          <p className="text-blue-200 text-sm">Join our network of institutional and private investors.</p>
        </div>
